...
module.exports = {
  sendEmailForgotPass: function (email, resetPasswordToken, callback) {
    const html = `
							...
							<td>
								<table style="background-color: #f2f3f8; max-width:670px;  margin:0 auto;" width="100%" border="0"
									...
									<tr>
										...
										<a href="ais.university.ac.id" title="logo" target="_blank">
									...
									<tr>
										<td style="text-align:center;">
											<p style="font-size:14px; color:rgba(69, 80, 86, 0.7411764705882353); line-height:18px; margin:0 0 0;">&copy; <strong>ais.university.ac.id</strong></p>
										</td>
									</tr>
									<tr>
										<td style="height:80px;">&nbsp;</td>
				...
				`;
    var mailOptions = {
			from: `AIS-University <` + process.env.SMTP_EMAIL_FROM + '>',
      to: email,
      subject: "reset password ais-university",
      html,
    };
							...
							<td>
                              ...
                              data.name
                                ...
                                data.departement_data
                                  ...
                                  : ""
                              } University. Your student number is ${student_number}. Use your student number as your username and password to complete the data on the page
														</p>
